...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mcp.empty": "Select or create an MCP server configuration",
    "mcp.basicSettings": "Configuration",
    "mcp.name": "Server Name",
    "mcp.nameRequired": "Server name is required",
    "mcp.namePlaceholder": "e.g. filesystem, memory, fetch",
    "mcp.scope": "Scope",
    "mcp.type": "Transport",
    "mcp.command": "Command",
    ...
    "mcp.envPlaceholder": "KEY=VALUE format, one per line",
    "mcp.url": "Server URL",
    "mcp.urlPlaceholder": "e.g. http://localhost:8000/sse",
    "mcp.descriptionField": "Description",
    "mcp.descriptionPlaceholder": "Optional server description",
    "mcp.enabled": "Enabled",
    ...
    "mcp.saved": "Saved",
    "mcp.delete": "Delete",
    "mcp.deleteConfirm": "Are you sure you want to delete this MCP server?",
    ...
    "skills.enabledCount": "Enabled {enabled} / {total}",
    "skills.clearFilter": "Clear filter",
    "skills.noMatches": "No matching skills",
    "skills.batchUpdating": "Updating skills…",
    "agents.close": "Close",
    ...
    "files.openInSidebar": "Open in sidebar",
    ...
    "i18n.disabledByFileRename": "Disabled via file rename (SKILL.md.disabled) — enabling restores the file and makes it visible again",
    ...
    "models.overview": "Model Filter",
    "models.overviewCopy": "Click to copy model id",
    "models.overviewSearchPlaceholder": "Search models or providers…",
    "models.overviewFilterAll": "All Providers",
    "models.overviewSelect": "Select",
    "models.overviewSelected": "Current",
    "models.overviewClearFilter": "Clear filter",
    "models.overviewNoMatches": "No models matching your search",
    "models.overviewExpandAll": "Expand all",
    "models.overviewCollapseAll": "Collapse all",
    "models.overviewDefault": "Default",
    "models.filterDesc": "Select which models appear in the chat model dropdown",
    "models.filterSave": "Save & Apply",
    "models.filterSaving": "Saving…",
    "models.filterSaved": "Saved!",
    "models.filterEnableAll": "Enable All",
    "models.filterDisableAll": "Disable All",
    "models.filterDropdownHint": "Only enabled models will appear in the chat model dropdown",
