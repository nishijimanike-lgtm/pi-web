...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mcp.title": "MCP 服务管理",
    "mcp.scope.global": "全局",
    "mcp.scope.project": "项目",
    "mcp.new": "新建 MCP 服务",
    "mcp.empty": "选择或新建一个 MCP 服务配置",
    "mcp.basicSettings": "基本配置",
    "mcp.name": "服务名称",
    "mcp.nameRequired": "请输入服务名称",
    ...
    "mcp.env": "环境变量",
    "mcp.envPlaceholder": "KEY=VALUE 格式，每行一个",
    "mcp.url": "服务 URL",
    "mcp.urlPlaceholder": "例如: http://localhost:8000/sse",
    "mcp.descriptionField": "描述说明",
    "mcp.descriptionPlaceholder": "可选的服务描述",
    "mcp.enabled": "已启用",
    "mcp.disabled": "已禁用",
    "mcp.status": "状态",
    "mcp.test": "测试连接",
    "mcp.testing": "测试中…",
    "mcp.testSuccess": "连接测试成功",
    "mcp.testFailed": "连接测试失败",
    "mcp.save": "保存",
    "mcp.saving": "保存中…",
    "mcp.saved": "已保存",
    "mcp.delete": "删除",
    "mcp.deleteConfirm": "确定要删除此 MCP 服务吗？",
    "mcp.noServers": "暂无已配置的 MCP 服务",
    "mcp.noProjectServers": "本项目暂无专属 MCP 服务",
    "mcp.presets": "常用预设模板",
    "mcp.discovered": "检测到系统已配置的外部服务",
    "mcp.quickImport": "快捷导入",
    "settings.title": "设置",
    "settings.general": "常规",
    ...
    "skills.enabledCount": "已启用 {enabled} / {total}",
    "skills.clearFilter": "清空筛选",
    "skills.noMatches": "未找到匹配的技能",
    "skills.batchUpdating": "正在批量更新技能…",
    "agents.close": "关闭",
    ...
    "files.download": "下载文件",
    "files.open": "打开",
    "files.openInApp": "在应用中打开",
    "files.openInSidebar": "在侧边栏打开",
    ...
    "i18n.disabledByFileRename": "已通过文件重命名禁用（SKILL.md.disabled）——启用将还原文件并重新可见",
    ...
    "models.overview": "模型过滤",
    "models.overviewCopy": "点击复制模型ID",
    "models.overviewSearchPlaceholder": "搜索模型或 Provider…",
    "models.overviewFilterAll": "全部 Provider",
    "models.overviewSelect": "选择",
    "models.overviewSelected": "当前使用",
    "models.overviewClearFilter": "清空筛选",
    "models.overviewNoMatches": "未找到匹配的模型",
    "models.overviewExpandAll": "全部展开",
    "models.overviewCollapseAll": "全部折叠",
    "models.overviewDefault": "默认",
    "models.filterDesc": "自定义交互窗口下拉菜单中显示的模型列表",
    "models.filterSave": "保存并应用",
    "models.filterSaving": "保存中…",
    "models.filterSaved": "已保存！",
    "models.filterEnableAll": "全部启用",
    "models.filterDisableAll": "全部禁用",
    "models.filterDropdownHint": "仅启用的模型会显示在交互窗口的模型下拉菜单中",
