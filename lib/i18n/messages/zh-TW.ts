...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "mcp.title": "MCP 服務管理",
    "mcp.scope.global": "全域",
    "mcp.scope.project": "專案",
    "mcp.new": "新增 MCP 服務",
    "mcp.empty": "選取或新增一個 MCP 服務設定",
    "mcp.basicSettings": "基本設定",
    "mcp.name": "服務名稱",
    "mcp.nameRequired": "請輸入服務名稱",
    "mcp.namePlaceholder": "例如: filesystem, memory, fetch",
    "mcp.scope": "作用範圍",
    "mcp.type": "傳輸通訊協定",
    "mcp.command": "執行命令",
    "mcp.commandPlaceholder": "例如: npx, uvx, node, python",
    "mcp.args": "參數列表",
    "mcp.argsPlaceholder": "每行一個參數",
    "mcp.env": "環境變數",
    "mcp.envPlaceholder": "KEY=VALUE 格式，每行一個",
    "mcp.url": "服務 URL",
    "mcp.urlPlaceholder": "例如: http://localhost:8000/sse",
    "mcp.descriptionField": "描述說明",
    "mcp.descriptionPlaceholder": "選填的服務描述",
    "mcp.enabled": "已啟用",
    "mcp.disabled": "已停用",
    "mcp.status": "狀態",
    "mcp.test": "測試連線",
    "mcp.testing": "測試中…",
    "mcp.testSuccess": "連線測試成功",
    "mcp.testFailed": "連線測試失敗",
    "mcp.save": "儲存",
    "mcp.saving": "儲存中…",
    "mcp.saved": "已儲存",
    "mcp.delete": "刪除",
    "mcp.deleteConfirm": "確定要刪除此 MCP 服務嗎？",
    ...
    "skills.searchPlaceholder": "搜尋技能名稱或描述…",
    "skills.filterAll": "全部",
    "skills.filterEnabled": "已啟用",
    "skills.filterDisabled": "已禁用",
    "skills.enableAll": "全部啟用",
    "skills.disableAll": "全部禁用",
    "skills.enabledCount": "已啟用 {enabled} / {total}",
    "skills.clearFilter": "清除篩選",
    "skills.noMatches": "找不到相符的技能",
    "skills.batchUpdating": "正在批次更新技能…",
    "agents.close": "關閉",
    ...
    "files.download": "下載檔案",
    "files.open": "開啟",
    "files.openInApp": "在應用程式中開啟",
    "files.openInSidebar": "在側邊欄開啟",
    "files.copyRelativePath": "複製相對路徑",
    "files.copyAbsolutePath": "複製絕對路徑",
    ...
    "i18n.disabledByFileRename": "已透過檔案重新命名停用（SKILL.md.disabled）——啟用將還原檔案並重新可見",
    ...
    "models.overview": "模型篩選",
    "models.overviewCopy": "點擊複製模型ID",
    "models.overviewSearchPlaceholder": "搜尋模型或 Provider…",
    "models.overviewFilterAll": "全部 Provider",
    "models.overviewSelect": "選擇",
    "models.overviewSelected": "目前使用",
    "models.overviewClearFilter": "清除篩選",
    "models.overviewNoMatches": "找不到相符的模型",
    "models.overviewExpandAll": "全部展開",
    "models.overviewCollapseAll": "全部折疊",
    "models.overviewDefault": "預設",
    "models.filterDesc": "自訂互動視窗下拉選單中顯示的模型清單",
    "models.filterSave": "儲存並套用",
    "models.filterSaving": "儲存中…",
    "models.filterSaved": "已儲存！",
    "models.filterEnableAll": "全部啟用",
    "models.filterDisableAll": "全部禁用",
    "models.filterDropdownHint": "僅啟用的模型會顯示在互動視窗的模型下拉選單中",
